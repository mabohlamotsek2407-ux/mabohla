...
$sql = "
    SELECT ei.*, s.registration_number, s.school_name 
...
function downloadExcel($data) {
    ...
    echo "Registration Number\tSchool Name\tCluster\tHas Electricity\tSource\tChallenges\tMitigations\tAdditional Info\n";
...
<head>
    ...
    <title>Electricity Infrastructure Management System - High Schools</title>
...
<body>
    <div class="dashboard-container">
        ...
        <div class="header-section">
            ...
            <p>View and manage the most recent electricity infrastructure data for high schools.</p>
        </div>
                ...
                <tbody>
                    <?php if (!empty($infrastructureData)): ?>
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($infrastructure['cluster'] ?? '') ?></td>
                            <td>
                                <?php 
