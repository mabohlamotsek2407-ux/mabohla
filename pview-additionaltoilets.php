...
function downloadExcel($data) {
    ...
    echo "Registration Number\tSchool Name\tCentre\tCurrent Enrolment\tAdditional Latrines Needed\tLatrine Groups\tNumber of Latrines\tRequests Made\tSummary\n";
...
<head>
    ...
    <title>Additional Toilets Management System</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="header-section">
            <h1>
                ...
                Additional Toilets Management System
            </h1>
            <p>View and manage the most recent additional toilets data for primary schools.</p>
        </div>
                ...
                <tbody>
                    <?php if (!empty($toiletsData)): ?>
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($toilet['centre'] ?? '') ?></td>
                            <td><?= htmlspecialchars($toilet['current_enrolment'] ?? '') ?></td>
                            <td>
                                <?php 
                                $needed = $toilet['additional_latrines_needed'] ?? 0;
                                if ($needed > 0): 
                                ?>
                                    <span class="status-yes"><?= $needed ?> Needed</span>
                                <?php else: ?>
                            ...
                            <td><?= htmlspecialchars($toilet['requests_made'] ?? '') ?></td>
                            <td><?= htmlspecialchars($toilet['summary'] ?? '') ?></td>
                            <td><?= htmlspecialchars($toilet['created_at'] ?? '') ?></td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="11" class="no-data">
                                ...
                                <div>No toilets records found matching the criteria.</div>
