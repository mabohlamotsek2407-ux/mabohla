...
// SQL query to fetch most recent classroom data per school_id
$query = "
    SELECT ac.*, s.registration_number
...
if ($result && $result->num_rows > 0) {
    $classroomRecords = $result->fetch_all(MYSQLI_ASSOC);
}
...
// If download requested via POST
    ...
    <div class="dashboard-container">
        ...
        <div class="header-section">
            <h1>
                ...
                Primary Classroom Management System
            </h1>
            <p>View and manage the most recent additional classrooms data for primary schools (Centre populated, Cluster null or empty). Professional dashboard for educational infrastructure oversight.</p>
        </div>
        ...
        <div class="table-container">
            <table>
                <thead>
                    <tr>
                        <th><i class="fas fa-id-badge"></i> Registration</th>
                        <th><i class="fas fa-map-marker-alt"></i> Region</th>
                        <th><i class="fas fa-school"></i> School</th>
                        <th><i class="fas fa-building"></i> Centre</th>
                        <th><i class="fas fa-users"></i> Enrollment</th>
                        <th><i class="fas fa-chalkboard-teacher"></i> Needs Classrooms</th>
                        <th><i class="fas fa-tools"></i> Infrastructure</th>
                        <th><i class="fas fa-file-alt"></i> Requests</th>
                        <th><i class="fas fa-layer-group"></i> Grades</th>
                        <th><i class="fas fa-list-ol"></i> Classroom Count</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if (!empty($classroomRecords)): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (strtolower($record['require_classrooms'] ?? '') === 'yes'): ?>
